        ...
        try {
            ...
            if (error) {
                ...
                if (error.message.includes('User already registered')) {
                    ...
                    regError.textContent = '❌ Proteção CAPTCHA ativada. Desative no Supabase ou configure um provedor.';
                } else if (error.message.includes('Database error saving new user')) {
                    regError.textContent = '❌ Erro no banco de dados. Tente novamente.';
                } else {

...
// Configurações
window.APP.CONFIG = {
    SUPABASE_URL: 'https://cccckpzwbdaycdwmvdyp.supabase.co',
...
console.log('🔗 Supabase URL:', window.APP.CONFIG.SUPABASE_URL);
console.log('🔑 Chave:', window.APP.CONFIG.SUPABASE_ANON_KEY.substring(0, 20) + '...');
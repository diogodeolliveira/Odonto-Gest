...
(function() {
    ...
    APP.init = async function() {
        // Protege contra dupla inicialização, caso o script seja
        // executado mais de uma vez (ex: extensão/antivírus injetando
        // recursos duplicados na página).
        if (APP._iniciado) {
    ...
    // Se o DOM já estiver pronto (ex.: script executado atrasado),
    // inicia imediatamente em vez de esperar um evento que já passou.

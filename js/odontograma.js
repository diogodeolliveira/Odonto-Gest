...
// Renderiza odontograma no cadastro
function renderOdontogramaCadastro() {
    ...
    function criarDente(num) {
        ...
        if (window.dentesSelecionados && window.dentesSelecionados.has(num)) {
        ...
        btn.addEventListener('click', function() {
            ...
            if (window.dentesSelecionados.has(dente)) {
                window.dentesSelecionados.delete(dente);
                this.classList.remove('selecionado');
            } else {
                window.dentesSelecionados.add(dente);
...
// Renderiza odontograma nos detalhes
